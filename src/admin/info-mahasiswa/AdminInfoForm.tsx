...
export const AdminInfoForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // 1. Upload inline images from full_description first
    const updatedFullDescription = await uploadInlineImages(formData.full_description);
    ...
    const payload = {
      ...formData,
      full_description: updatedFullDescription,
