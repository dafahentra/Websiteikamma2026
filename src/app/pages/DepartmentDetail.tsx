    ...
    <div className="min-h-screen bg-white text-[#081C36] overflow-hidden">
      ...
      <section className="relative pt-40 pb-0 px-6 lg:px-12 flex flex-col items-center min-h-[80vh] md:min-h-screen">
        ...
        >
          ...
          <h1 className="text-3xl md:text-5xl lg:text-7xl font-inter font-black tracking-tight max-w-5xl text-[#081C36] leading-tight">
            {department.name}
          </h1>
        </motion.div>
        ...
        <div className="relative w-full flex flex-row justify-between items-end mt-auto h-[320px] md:h-[500px] max-w-[1800px] mx-auto px-0">
          ...
          >
            <div className="h-full w-auto shrink-0 relative">
              ...
              >
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-black font-inter whitespace-nowrap drop-shadow-md">{department.manager}</h3>
          ...
          >
            <div className="h-full w-auto shrink-0 relative">
              ...
              <motion.div
                ...
                transition={{ duration: 0.8, delay: 0.8 }}
              >
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-black font-inter whitespace-nowrap drop-shadow-md">{department.viceManager}</h3>
          ...
          <div className="md:hidden absolute top-[12%] left-1/2 -translate-x-1/2 flex justify-between items-start z-20 w-full px-[60px]">
            <div className="text-left">
              <h3 className="text-sm font-black font-inter text-[#081C36] drop-shadow-sm">{department.manager}</h3>
              <p className="text-[#081C36]/50 text-[10px] font-bold uppercase tracking-widest">Manager</p>
            </div>
            <div className="text-right">
              <h3 className="text-sm font-black font-inter text-[#081C36] drop-shadow-sm">{department.viceManager}</h3>
