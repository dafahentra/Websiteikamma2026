                  ...
                  <div className="absolute top-2 left-2 md:top-4 md:left-4 flex items-center gap-1.5 md:gap-2">
                      ...
                      if (displayType === 'ongoing') {
                        return (
                          <div className="flex items-center justify-center gap-1.5 bg-[#081C36]/50 backdrop-blur-xl px-2.5 md:px-3.5 h-6 md:h-8 rounded-full border border-white/20 shadow-lg">
                            ...
                            <span className="text-white text-[9px] md:text-[10px] font-inter font-bold tracking-wider uppercase leading-none">ONGOING</span>
                          </div>
                        );
                         ...
                         return (
                          <div className="flex items-center justify-center bg-[#081C36]/50 backdrop-blur-xl px-2.5 md:px-3.5 h-6 md:h-8 rounded-full border border-white/20 shadow-lg">
                            <span className="text-white text-[9px] md:text-[10px] font-bold tracking-wider uppercase leading-none">Past Event</span>
                          </div>
                        );
                      } else {
                        return (
                          <div className="flex items-center justify-center bg-[#081C36]/50 backdrop-blur-xl px-2.5 md:px-3.5 h-6 md:h-8 rounded-full border border-white/20 shadow-lg">
                            <span className="text-white text-[9px] md:text-[10px] font-bold tracking-wider uppercase leading-none">Upcoming</span>
                          </div>
                        );
                      }
                    })()}
                    ...
                    {event.category && (
                      <div className="flex items-center justify-center bg-[#081C36]/50 backdrop-blur-xl px-2.5 md:px-3.5 h-6 md:h-8 rounded-full shadow-lg border border-white/20">
                        <span className="text-white text-[9px] md:text-[10px] font-inter font-bold tracking-wider uppercase leading-none">{event.category}</span>
                      </div>
                    )}
                  </div>
