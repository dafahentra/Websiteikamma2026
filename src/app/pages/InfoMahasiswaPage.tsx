              ...
              >
                    ...
                    {(() => {
                      ...
                      return displayStatus === 'open' ? (
                        <div className="flex items-center justify-center gap-1.5 bg-[#081C36]/50 backdrop-blur-xl px-3.5 h-7 md:px-4 md:h-8 rounded-full border border-white/20 shadow-lg">
                          <span className="w-1.5 h-1.5 md:w-2 md:h-2 bg-green-400 rounded-full animate-pulse shadow-[0_0_8px_rgba(74,222,128,0.8)] shrink-0" />
                          <span className="text-white text-[10px] md:text-xs font-inter font-bold leading-none tracking-wider uppercase">OPEN</span>
                        </div>
                      ) : (
                        <div className="flex items-center justify-center bg-[#081C36]/50 backdrop-blur-xl px-3.5 h-7 md:px-4 md:h-8 rounded-full border border-white/20 shadow-lg">
                          <span className="text-white text-[10px] md:text-xs font-inter font-bold leading-none tracking-wider uppercase">CLOSED</span>
                        </div>
                      );
                    })()}
                  </div>
                ...
                <div className="p-3 md:p-5 flex flex-col flex-grow">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-1 mb-3">
                    <span className={`inline-flex items-center justify-center px-3.5 py-1 md:px-4 md:py-1.5 rounded-full text-white text-[10px] md:text-[11px] font-inter font-bold leading-none uppercase tracking-wider ${CATEGORY_COLORS[item.category]}`}>
                      {item.category}
                    </span>
