...
// ── Foto Program Kerja ──────────────────────────────────────────────────
import ProkerSchoolOfIKAMMA from '../assets/FotoProker/HRBB/SchoolOfIKAMMA.webp';
import ProkerOpenRecruitment from '../assets/FotoProker/HRBB/OpenRecruitment.webp';
import ProkerSerahTerimaJabatan from '../assets/FotoProker/HRBB/SerahTerimaJabatan.webp';
import ProkerInternalUpgrading from '../assets/FotoProker/HRBB/InternalUpgrading.webp';
import ProkerIKAMMAUpgradingProgram from '../assets/FotoProker/HRBB/IKAMMAUpgradingProgram.webp';
import ProkerMagangIkamma from '../assets/FotoProker/HRBB/MagangIkamma.webp';
import ProkerIkammaConnect from '../assets/FotoProker/HRBB/IkammaConnect.webp';
import ProkerMonthlyAppreciationPost from '../assets/FotoProker/HRBB/MonthlyAppreciationPost.webp';
import ProkerBirthdayCalendar from '../assets/FotoProker/HRBB/BirthdayCalendar.webp';
import ProkerFarewellikamma from '../assets/FotoProker/HRBB/Farewellikamma.webp';
import ProkerAppraisalForm from '../assets/FotoProker/HRM/AppraisalForm.webp';
import ProkerIED from '../assets/FotoProker/HRM/IED.webp';
import ProkerStaffOfTheMonth from '../assets/FotoProker/HRM/StaffOfTheMonth.webp';
import ProkerSchoolofmarketingmedia from '../assets/FotoProker/MM/Schoolofmarketingmedia.webp';
import ProkerSocialMedia from '../assets/FotoProker/MM/SocialMedia.webp';
import ProkerCreativeProduction from '../assets/FotoProker/MM/CreativeProduction.webp';
import ProkerWebsite from '../assets/FotoProker/MM/Website.webp';
import ProkerKesekretariatan from '../assets/FotoProker/ADVANCE/Kesekretariatan.webp';
import ProkerKebendaharaan from '../assets/FotoProker/ADVANCE/Kebendaharaan.webp';
import ProkerKerumahtanggaan from '../assets/FotoProker/ADVANCE/Kerumahtanggaan.webp';
import ProkerSoerti from '../assets/FotoProker/INTERNAL/Soerti.webp';
import ProkerPaam from '../assets/FotoProker/INTERNAL/Paam.webp';
import ProkerDebatInternal from '../assets/FotoProker/INTERNAL/DebatInternal.webp';
import ProkerIcare from '../assets/FotoProker/INTERNAL/Icare.webp';
import ProkerMweek from '../assets/FotoProker/INTERNAL/Mweek.webp';
import ProkerPartnership from '../assets/FotoProker/EXTERNAL/Partnership.webp';
import ProkerTerimaKunjungan from '../assets/FotoProker/EXTERNAL/TerimaKunjungan.webp';
import ProkerCompanyVisit from '../assets/FotoProker/EXTERNAL/CompanyVisit.webp';
import ProkeriNext from '../assets/FotoProker/EXTERNAL/iNext.webp';
import ProkerIKAMMAVisit from '../assets/FotoProker/EXTERNAL/IKAMMAVisit.webp';
import ProkerIKAMMAAlumniDatabase from '../assets/FotoProker/EXTERNAL/IKAMMAAlumniDatabase.webp';
import ProkerManajemenFacilitator from '../assets/FotoProker/INDEV/ManajemenFacilitator.webp';
import ProkerCareerInsight from '../assets/FotoProker/INDEV/CareerInsight.webp';
import ProkerReady from '../assets/FotoProker/INDEV/Ready.webp';
import ProkerEClub from '../assets/FotoProker/ENTRE/EClub.webp';
import ProkerYes from '../assets/FotoProker/ENTRE/Yes.webp';
import ProkerEntrive from '../assets/FotoProker/ENTRE/Entrive.webp';
import ProkerPoskam from '../assets/FotoProker/SPARTA/Poskam.webp';
import ProkerMenefest from '../assets/FotoProker/SPARTA/Menefest.webp';
import ProkerGMSC from '../assets/FotoProker/SPARTA/GMSC.webp';
import ProkerSprite from '../assets/FotoProker/SPARTA/Sprite.webp';
...
export const departmentsData: Record<string, DepartmentData> = {
  'hrbb': {
    ...
    logo: LogoHRBB,
    programs: [
      { id: 1, title: "School of IKAMMA", img: ProkerSchoolOfIKAMMA, description: "Program pengenalan IKAMMA bagi mahasiswa baru untuk memahami peran IKAMMA, struktur organisasi, budaya kerja, fungsi biro dan departemen, serta ruang kontribusi sesuai minat dan kompetensi. Program kerja ini mendukung proses onboarding yang lebih sistematis dan memudahkan adaptasi awal." },
      { id: 2, title: "Open Recruitment", img: ProkerOpenRecruitment, description: "Proses rekrutmen pengurus yang bertujuan menjaring kandidat, memetakan kompetensi dan minat, serta menempatkan calon pengurus pada biro dan departemen yang sesuai. Program kerja ini menjadi fondasi awal penempatan sumber daya manusia yang tepat agar kinerja dan pengalaman berorganisasi lebih optimal." },
      { id: 3, title: "Sertijab X IKAMMA Orientation Day", img: ProkerSerahTerimaJabatan, description: "Program kerja transisi kepengurusan yang memfasilitasi serah terima jabatan dan transfer of knowledge dari pengurus sebelumnya. Program ini bertujuan mempercepat adaptasi pengurus baru dan meningkatkan kesiapan kerja sejak awal periode." },
      { id: 4, title: "Internal Upgrading", img: ProkerInternalUpgrading, description: "Program peningkatan kapasitas yang disesuaikan dengan kebutuhan masing-masing biro dan departemen. HR Birdept Buddy memfasilitasi materi dan dukungan pelaksanaan agar efektivitas kerja serta kualitas output dari masing-masing biro dan departemen meningkat." },
      { id: 5, title: "IKAMMA Upgrading Program", img: ProkerIKAMMAUpgradingProgram, description: "Program berbentuk seminar interaktif dan workshop untuk pengembangan hard skill maupun soft skill dari pengurus IKAMMA secara menyeluruh. Program ini ditujukan untuk meningkatkan kompetensi pengurus sekaligus memperkuat standar kualitas kerja organisasi." },
      { id: 6, title: "Magang IKAMMA", img: ProkerMagangIkamma, description: "Program kerja yang menawarkan mahasiswa baru Manajemen FEB UGM kesempatan magang di IKAMMA untuk memperoleh pengalaman berkontribusi secara langsung selama periode magang. Program ini memperluas eksposur, membangun kesiapan kader, dan mendukung regenerasi yang lebih terstruktur." },
      { id: 7, title: "IKAMMA Connect", img: ProkerIkammaConnect, description: "Program kerja bagi pengurus internal IKAMMA yang berbentuk nonformal (misalnya outbound) untuk memperkuat rasa kebersamaan, meningkatkan kedekatan antarpengurus, serta membangun suasana kerja yang lebih suportif dan solid." },
      { id: 8, title: "Monthly Appreciation Post", img: ProkerMonthlyAppreciationPost, description: "Program apresiasi bulanan berupa rangkuman capaian program kerja dalam format publikasi yang lebih terstruktur, sebagai bentuk pengakuan atas kontribusi dan hasil kerja pengurus biro dan departemen yang telah menyelesaikan program kerja." },
      { id: 9, title: "Birthday Calendar", img: ProkerBirthdayCalendar, description: "Program engagement internal melalui pengelolaan kalender ulang tahun dan penyampaian apresiasi personal. Program ini bertujuan untuk meningkatkan kedekatan, perhatian, dan rasa memiliki dalam lingkungan organisasi." },
      { id: 10, title: "Farewell IKAMMA", img: ProkerFarewellikamma, description: "Program perpisahan untuk mengapresiasi kontribusi pengurus di akhir periode." },
    ],
    staffs: [
  ...
  'hr-monitoring': {
    ...
    managerLinkedIn: "https://www.linkedin.com/in/nurizha-meila/",
    viceManager: "Nisrinatsani Daffa",
    viceManagerLinkedIn: "https://www.linkedin.com/in/nisrinatsanidaffafakhira/",
    description: "Human Resource Monitoring (HRM) merupakan biro baru di IKAMMA yang merupakan hasil pemekaran dari Biro Human Resource, dengan tugas utama memastikan kinerja pengurus serta pelaksanaan program kerja tetap selaras dengan visi dan misi IKAMMA.",
    managerImg: HRMManager,
    viceManagerImg: HRMViceManager,
    groupImg: GroupHRM,
    logo: LogoHRM,
    programs: [
      { id: 11, title: "School of IKAMMA", img: ProkerSchoolOfIKAMMA, description: "Program pengenalan IKAMMA bagi mahasiswa baru untuk memahami peran IKAMMA, struktur organisasi, budaya kerja, fungsi biro dan departemen, serta ruang kontribusi sesuai minat dan kompetensi. Program kerja ini mendukung proses onboarding yang lebih sistematis dan memudahkan adaptasi awal." },
      { id: 12, title: "Open Recruitment", img: ProkerOpenRecruitment, description: "Proses rekrutmen pengurus yang bertujuan menjaring kandidat, memetakan kompetensi dan minat, serta menempatkan calon pengurus pada biro dan departemen yang sesuai. Program kerja ini menjadi fondasi awal penempatan sumber daya manusia yang tepat agar kinerja dan pengalaman berorganisasi lebih optimal." },
      { id: 13, title: "Sertijab X IKAMMA Orientation Day", img: ProkerSerahTerimaJabatan, description: "Program kerja transisi kepengurusan yang memfasilitasi serah terima jabatan dan transfer of knowledge dari pengurus sebelumnya. Program ini bertujuan mempercepat adaptasi pengurus baru dan meningkatkan kesiapan kerja sejak awal periode." },
      { id: 14, title: "Appraisal Form (AF)", img: ProkerAppraisalForm, description: "Program kerja yang dilaksanakan untuk memberikan laporan terkait kinerja pengurus IKAMMA selama periode kepengurusan dalam bentuk rapor individu yang menjadi gambaran evaluasi. Program ini memberikan kesempatan kepada pengurus untuk memberikan dan mendapatkan penilaian secara anonim. Appraisal Form dilaksanakan dua kali dalam satu periode kepengurusan, yaitu pada pertengahan dan akhir periode." },
      { id: 15, title: "IKAMMA Evaluation and Appreciation Day (IED)", img: ProkerIED, description: "Program kerja ini dilaksanakan pada pertengahan dan akhir masa kepengurusan dengan tujuan melakukan evaluasi serta apresiasi atas kinerja pengurus IKAMMA selama periode tersebut. Setiap biro dan departemen serta masing-masing chairperson akan mendapat giliran untuk memberikan evaluasi satu sama lain." },
      { id: 16, title: "Staff of The Month", img: ProkerStaffOfTheMonth, description: "Program kerja yang menentukan best Staff, Manager, dan Vice Manager di setiap bulan. Program kerja Staff of The Month memiliki tujuan untuk mengapresiasi Staff, Manager, dan Vice Manager dengan performa terbaik setiap bulan serta meningkatkan motivasi dan semangat berorganisasi." },
    ],
    staffs: [
  ...
  'mm': {
    ...
    managerLinkedIn: "https://www.linkedin.com/in/winonazwetta-diandra-aurora/",
    viceManager: "Keisha Naila",
    viceManagerLinkedIn: "https://www.linkedin.com/in/keisha-naila/",
    description: "Marketing Media merupakan biro yang memiliki fungsi untuk membangun citra dan wajah IKAMMA serta memperkenalkannya kepada publik dengan penyampaian informasi dan digitalisasi melalui berbagai media. Biro Marketing Media juga menjadi support system yang membantu mempublikasikan program kerja dan event yang dimiliki masing-masing biro dan departemen ke hadapan publik.",
    managerImg: MMManager,
    viceManagerImg: MMViceManager,
    groupImg: GroupMM,
    logo: LogoMM,
    programs: [
      { id: 17, title: "School of Marketing Media", img: ProkerSchoolofmarketingmedia, description: "Program kerja berbentuk pelatihan internal yang diselenggarakan oleh biro Marketing Media untuk memastikan arah dan kualitas konten selaras dengan nilai-nilai IKAMMA FEB UGM. Program ini sekaligus menjadi sarana pengembangan kompetensi bagi staf dalam bidang marketing dan media secara berkelanjutan." },
      { id: 18, title: "Social Media", img: ProkerSocialMedia, description: "Program kerja ini menjadi sarana utama yang digunakan untuk membangun dan memperkuat branding IKAMMA sekaligus mengenalkan IKAMMA kepada publik. Program kerja ini berfokus pada pengelolaan media sosial IKAMMA (Instagram, TikTok, Twitter, dan LinkedIn) secara profesional guna membentuk persepsi positif audiens terhadap IKAMMA." },
      { id: 19, title: "Creative Production", img: ProkerCreativeProduction, description: "Program kerja yang berfokus pada perencanaan, pembuatan, dan pengelolaan konten kreatif yang berkaitan dengan IKAMMA FEB UGM. Program ini menghasilkan berbagai konten, seperti video profile dan konten trivia, yang dipublikasikan melalui akun resmi YouTube IKAMMA." },
      { id: 20, title: "Website IKAMMA", img: ProkerWebsite, description: "Program kerja yang berperan sebagai platform resmi IKAMMA FEB UGM dalam menyampaikan informasi kepada publik dan pihak eksternal. Informasi yang disajikan meliputi profil organisasi, visi misi, program kerja, bank soal IKAMMA, dan lain sebagainya. Program ini bertujuan membangun citra IKAMMA sebagai organisasi mahasiswa yang profesional." },
    ],
    staffs: [
  ...
  'advance': {
    ...
    viceManagerLinkedIn: "https://www.linkedin.com/in/muhamad-fikri-akbar/",
    description: "Administration and Finance (Advance) merupakan biro yang memiliki peran dalam mengelola administrasi dan keuangan di IKAMMA serta memastikan setiap program kerja maupun event yang dimiliki masing-masing biro dan departemen dapat berjalan dengan tertib, efisien, dan transparan. Biro Advance bertanggung jawab terhadap seluruh proses administrasi, pengelolaan keuangan, serta inventarisasi aset organisasi yang berguna untuk mendukung kelancaran program kerja maupun event IKAMMA.",
    managerImg: AdvanceManager,
    viceManagerImg: AdvanceViceManager,
    groupImg: GroupAdvance,
    logo: LogoAdvance,
    programs: [
      { id: 21, title: "Kesekretariatan", img: ProkerKesekretariatan, description: "Program kerja yang berisi pengelolaan surat-menyurat, proposal kegiatan, dan LPJ. Tugas Advance memastikan semua dokumen tersusun dengan rapi dan sistematis sesuai dengan ketentuan yang berlaku. Advance berperan sebagai pihak perantara administratif antara fakultas dan IKAMMA dalam proses koordinasi, perizinan, dan penyampaian informasi." },
      { id: 22, title: "Kebendaharaan", img: ProkerKebendaharaan, description: "Program kerja yang bertanggung jawab atas pengelolaan keuangan organisasi. Mulai dari pencatatan seluruh pemasukan dan pengeluaran, pengelolaan anggaran kegiatan, dan menyusun LPJ yang transparan. Program kerja Kebendaharaan sangat penting untuk memastikan bahwa penggunaan dana organisasi sudah sesuai dengan ketentuan dan dapat mendukung keberlanjutan seluruh program kerja di IKAMMA." },
      { id: 23, title: "Kerumahtanggaan", img: ProkerKerumahtanggaan, description: "Program kerja terkait pengelolaan inventaris dan peminjaman barang organisasi. Biro Advance memastikan seluruh kebutuhan logistik dan aset organisasi tersedia dan tercatat dengan rapi agar mempermudah penggunaan aset di masa mendatang." },
    ],
    staffs: [
  ...
  'internal': {
    ...
    managerLinkedIn: "https://www.linkedin.com/in/bachtiarrizki/",
    viceManager: "Darrel Raditya",
    viceManagerLinkedIn: "https://www.linkedin.com/in/darrel-raditya/",
    description: "Internal merupakan departemen yang memiliki tugas untuk membangun rasa saling memiliki, menumbuhkan nilai kekeluargaan, dan meningkatkan rasa solidaritas di antara mahasiswa Manajemen FEB UGM. Melalui berbagai program kerja, Departemen Internal berperan dalam menciptakan lingkungan yang inklusif, suportif, dan nyaman sebagai wadah pengembangan relasi serta kebersamaan antar mahasiswa.",
    managerImg: IntManager,
    viceManagerImg: IntViceManager,
    groupImg: GroupInternal,
    logo: LogoInternal,
    programs: [
      { id: 24, title: "Soegeng Rawoeh to IKAMMA (SOERTI)", img: ProkerSoerti, description: "SOERTI merupakan program kerja dari departemen Internal yang berisi rangkaian penyambutan mahasiswa baru program studi Manajemen FEB UGM guna mempersiapkan mahasiswa baru pada kehidupan perkuliahan di Manajemen dengan memperkenalkan jurusan Manajemen, menanamkan nilai nilai IKAMMA, memilih dan mempersiapkan ketua angkatan, serta menawarkan mahasiswa baru untuk menjadi pengurus IKAMMA." },
      { id: 25, title: "Penyatuan Aspirasi dan Apresiasi Manajemen (PAAM)", img: ProkerPaam, description: "Program kerja PAAM bertujuan untuk meningkatkan rasa saling memiliki dan solidaritas antar mahasiswa manajemen FEB UGM. Aspirasi dari mahasiswa manajemen akan disampaikan kepada pengurus IKAMMA. Program ini juga akan memberikan apresiasi kepada seluruh mahasiswa manajemen, baik berupa ucapan selamat ulang tahun, penghargaan kepada mahasiswa berprestasi, maupun penghargaan kelulusan." },
      { id: 26, title: "Debat Internal", img: ProkerDebatInternal, description: "Program kerja Debat Internal bertujuan untuk memberikan kesempatan kepada calon chairperson untuk secara terbuka dan transparan saling beradu pandangan, program kerja, visi, dan misi mereka untuk masa jabatan satu tahun ke depan didepan anggota IKAMMA." },
      { id: 27, title: "I-Care Volunteer", img: ProkerIcare, description: "IKAMMA Care (I-Care) Volunteer merupakan program kerja yang bertujuan untuk meningkatkan kesadaran dan jiwa sosial keluarga manajemen serta mengembangkan sikap dermawan dalam membantu sesama melalui rangkaian bakti sosial. Pendaftaran volunteer I-Care terbuka untuk seluruh mahasiswa aktif Manajemen FEB UGM dengan mengusung konsep yang tidak hanya acara bakti sosial formal, melainkan juga memberikan dampak keberlanjutan bagi masyarakat secara luas." },
      { id: 28, title: "Management’s Week (M-WEEK)", img: ProkerMweek, description: "Program kerja ini berupa pekan keakraban mahasiswa-mahasiswi Manajemen FEB UGM, khususnya sebagai wadah pengenalan kegiatan non-akademik kepada mahasiswa baru. Harapannya, kegiatan ini mampu mempererat pertemanan di keluarga Manajemen tanpa adanya unsur senioritas." },
    ],
    staffs: [
  ...
  'external': {
    ...
    managerLinkedIn: "https://www.linkedin.com/in/dewamaderadityaa/",
    viceManager: "Glorio Gracias",
    viceManagerLinkedIn: "https://www.linkedin.com/in/glorionapitupulu/",
    description: "External Affairs merupakan departemen yang memiliki peran sebagai lini terdepan dan representasi organisasi dalam menjalin serta mengelola hubungan dengan pihak eksternal IKAMMA. Departemen External Affairs berfokus pada diplomasi dan profesionalisme dalam membangun kolaborasi yang strategis dengan perusahaan, organisasi eksternal, serta alumni dari Manajemen FEB UGM dengan upaya menciptakan networking yang luas dan membuka career pathways bagi mahasiswa Manajemen FEB UGM.",
    managerImg: ExtManager,
    viceManagerImg: ExtViceManager,
    groupImg: GroupExternal,
    logo: LogoExternal,
    programs: [
      { id: 29, title: "Partnership", img: ProkerPartnership, description: "Partnership merupakan program kerja yang menjadi jembatan untuk memfasilitasi segala kebutuhan organisasi dengan membuat dan merawat kerjasama yang bersifat mutual bersama stakeholder external yang berupa sebuah bisnis maupun organisasi." },
      { id: 30, title: "Terima Kunjungan", img: ProkerTerimaKunjungan, description: "Program kerja yang memiliki tujuan untuk mewadahi studi banding antar himpunan mahasiswa untuk memperluas wawasan, melatih kemampuan komunikasi dan organisasi, serta membangun relasi dan jejaring antar organisasi universitas lain." },
      { id: 31, title: "Company Visit", img: ProkerCompanyVisit, description: "Program kerja yang berupa kegiatan kunjungan ke perusahaan yang bertujuan untuk meningkatkan pemahaman civitas Manajemen FEB UGM mengenai dunia kerja secara langsung, serta membangun relasi dengan para profesional sebagai alat pengembangan karier." },
      { id: 32, title: "IKAMMA Networking for External (iNEXT)", img: ProkeriNext, description: "Program kerja yang menjadi sarana penghubung antara mahasiswa dan alumni Universitas Gadjah Mada. Melalui format podcast, iNEXT mengundang alumni dari berbagai latar belakang untuk berbagi wawasan, pengalaman profesional, dan insight dalam karier bagi civitas FEB UGM." },
      { id: 33, title: "IKAMMA Visit", img: ProkerIKAMMAVisit, description: "IKAMMA Visit (IKVIS) adalah bentuk dari kolaborasi dua program kerja, yaitu TRIKUN dan COMVIS. Program ini dilaksanakan sebagai wadah kunjungan terintegrasi yang bertujuan untuk memperkuat hubungan strategis dengan organisasi eksternal dan dunia industri, sekaligus memperluas wawasan relasi, dan eksposur profesional bagi mahasiswa Manajemen FEB UGM." },
      { id: 34, title: "IKAMMA Alumni Database", img: ProkerIKAMMAAlumniDatabase, description: "IKAMMA Alumni Database (IAD) adalah salah satu program kerja Departemen External yang mengelola database Alumni Manajemen FEB UGM untuk menjadi sarana penghubung antara alumni dengan mahasiswa aktif Manajemen FEB UGM, sehingga menciptakan mutual benefit untuk kedua pihak." },
    ],
    staffs: [
  ...
  'sparta': {
    ...
    manager: "Odillo Nodas",
    viceManager: "Sultan Fairuz",
    description: "Sport and Art Association (Sparta) merupakan departemen yang hadir untuk memberikan ruang kepada seluruh mahasiswa Manajemen FEB UGM dalam mengembangkan minat dan bakat di bidang olahraga dan seni. Departemen Sport and Art Association berfungsi sebagai wadah untuk mengintegrasikan aktivitas fisik dengan kreativitas, serta menciptakan keseimbangan antara kehidupan akademik dan non akademik.",
    managerImg: SpartaManager,
    viceManagerImg: SpartaViceManager,
    groupImg: GroupSparta,
    logo: LogoSparta,
    programs: [
      { id: 41, title: "Pekan Olahraga dan Seni Keluarga Manajemen (POSKAM)", img: ProkerPoskam, description: "Program kerja ini hadir sebagai wadah pengembangan dan penyaluran minat serta bakat mahasiswa Manajemen FEB UGM di bidang olahraga dan seni. Melalui berbagai kegiatan rutin yang diselenggarakan setiap bulan, seperti futsal, basket, bulu tangkis, jamming session, dan karaoke night, POSKAM menjadi ruang bagi mahasiswa untuk berekspresi, berprestasi, sekaligus mempererat kebersamaan antar mahasiswa." },
      { id: 42, title: "Management’s Festival (MENEFEST)", img: ProkerMenefest, description: "Management’s Festival atau MENEFEST adalah program kerja berbentuk event yang bertujuan untuk merayakan hari ulang tahun Manajemen FEB UGM. Acara ini sendiri memiliki main event yaitu charity run, dengan dua side events yaitu talkshow, medical check up, dan bakti sosial bersama I-Care milik Departemen Internal." },
      { id: 43, title: "Gadjah Mada Super Cup (GMSC)", img: ProkerGMSC, description: "Program kerja berbentuk event dari Departemen Sport and Art Association yang berupa kompetisi futsal yang ditujukan untuk seluruh siswa SMA/SMK sederajat di wilayah DIY dan sekitarnya. Melalui program ini, Departemen Sport and Art Association memiliki tujuan untuk memberikan kesempatan mereka untuk berkompetisi dalam suasana yang sehat dan menyenangkan. Di akhir rangkaian acaranya, program kerja ini akan dimeriahkan dengan sebuah konser besar." },
      { id: 44, title: "Sparta Info Terkini (Sprite)", img: ProkerSprite, description: "SPARTA Info Terkini atau yang biasa disebut dengan SPRITE, merupakan program kerja bulanan yang berisikan tentang informasi terkini seputar olahraga dan seni." },
    ],
    staffs: [
